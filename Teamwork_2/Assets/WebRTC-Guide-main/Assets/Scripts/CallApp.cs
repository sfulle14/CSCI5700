...
public class CallApp : MonoBehaviour
{
    ...
    public virtual void Send(string msg)
    {
        ...
        // msg: "LOG" "" 3
        //CASES:
        // CASE 1: They are texting. 1. You just need to show it in the chat box of other player
        // CASE 2: Player 2 made a mistake. Fire a bool (2). You receive it on the other end. It is gonna trigger the penality message.
        // Once a decision is made, you send another bool. 
        // CASE 3: Log files. Optional
    }
